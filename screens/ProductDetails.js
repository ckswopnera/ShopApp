...
const ProductDetails = (props) => {
    ...
    const handleAddProduct = async () => {
        ...
        try {
            ...
            DialogBox_success(`Product added successfully ${emoji.smile_emoji}`)
        } catch (error) {
    ...
    return (
        <>{isLoading === true ? <ActivityIndicator
            ...
            <>
                ...
                ><Text style={{ color: '#fff', fontWeight: 'bold', fontSize: 22, textAlign: 'center' }}>Add Product</Text></TouchableOpacity>
            </>
